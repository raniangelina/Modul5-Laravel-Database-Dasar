                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="lastName" class="form-label">Last
                                Name</label>
                            <input class="form-control" type="text" name="lastName" id="lastName" value="<?php echo e(old('lastNameSS')); ?>" placeholder="Enter Last Name">
                        </div>
                        <div class="col-md-6 mb-3">
...
</html><?php /**PATH E:\xampp\htdocs\ComposernView\resources\views/employee/create.blade.php ENDPATH**/ ?>